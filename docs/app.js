...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {restaurant: '', mdl: _debois$elm_mdl$Material$model},
			...
			_0: A2(
				_debois$elm_mdl$Material_Card$title,
				{
					...
					_0: _debois$elm_mdl$Material_Color$background(
						A2(_debois$elm_mdl$Material_Color$color, _debois$elm_mdl$Material_Color$Blue, _debois$elm_mdl$Material_Color$S400)),
					_1: {
						ctor: '::',
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$GetRandomRestaurant),
												_1: {ctor: '[]'}
											}
										}
									}
